...
web_research_task = Task(
    description=dedent(
        "Get valuable and high quality web information about the differences between a TPU and a GPU"),
    expected_output=dedent("Your task is to gather high quality information about the differences between"
                           " TPUs and GPUs"),
...
create_linkedin_post_task = Task(
    description=dedent(
        "Create a LinkedIn post about the differences between TPUs and GPUs following the writing-style "
        "expressed in the scraped LinkedIn posts."
    ),
    expected_output=dedent("A high-quality and under 200 words LinkedIn post. The LinkedIn post must follow"
